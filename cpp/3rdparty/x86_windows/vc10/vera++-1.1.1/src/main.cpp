...
const char *programVersion = "Vera++ 1.1.1 (Community Edition)";
        ...
        while (i != argc)
        {
            ...
            if (arg == "-help")
            {
                cout << "vera++ [options] [list-of-files]\n\n"
                    ...
                    "-homefolder folder set the vera++ home folder\n\n"
            ...
            else if (arg == "-homefolder")
            {
                ...
                {
                cerr << "error: option -homefolder provided without name of folder\n";
                exit(exitCodeOnFailure);
                }
            }
