...
Trentino::Binding::SCA::SubCodeToReasonMap Trentino::Binding::SCA::FaultDetailBuilder::createValueMap()
{
...
//constructor
Trentino::Binding::SCA::DefaultFaultDetailBuilder::DefaultFaultDetailBuilder( 
...
void Trentino::Binding::SCA::DefaultFaultDetailBuilder::setDefaultDetail(const std::string& detail )
{
   mDefaultDetail =  detail;
}

std::string Trentino::Binding::SCA::DefaultFaultDetailBuilder::createSubCode
...
std::string Trentino::Binding::SCA::DefaultFaultDetailBuilder::createReason
   (const Trentino::RuntimeModel::ErrorCode& /*ec*/) const
{
   std::string result;
