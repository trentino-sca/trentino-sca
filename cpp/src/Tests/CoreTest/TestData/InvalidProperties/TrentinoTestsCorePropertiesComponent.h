...
namespace Properties
{
	...
	public:	 
      ...
      void setPropertyWithNoDefaultValue(const std::string& value);	
      void setOptionalPropertyWithNoDefaultValue(const std::string& value);
      void setIntProperty(int32_t value);
	}; //class Component
} //namespace Trentino
} //namespace Tests
} //namespace Core
