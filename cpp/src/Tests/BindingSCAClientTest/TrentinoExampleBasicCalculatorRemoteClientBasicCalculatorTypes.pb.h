...
// source: TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes.proto

#ifndef PROTOBUF_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto__INCLUDED
#define PROTOBUF_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto__INCLUDED
...
void  protobuf_AddDesc_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto();
void protobuf_AssignDesc_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto();
void protobuf_ShutdownFile_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto();
...
class PB_Address : public ::google::protobuf::MessageLite {
 public:
  ...
  // optional .Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_Phone phone = 2;
  inline bool has_phone() const;
  inline void clear_phone();
  static const int kPhoneFieldNumber = 2;
  inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone& phone() const;
  inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone* mutable_phone();
  inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone* release_phone();
  
  // @@protoc_insertion_point(class_scope:Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_Address)
 private:
  ...
  ::std::string* street_;
  ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone* phone_;
  
  mutable int _cached_size_;
  ::google::protobuf::uint32 _has_bits_[(2 + 31) / 32];
  
  friend void  protobuf_AddDesc_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto();
  friend void protobuf_AssignDesc_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto();
  friend void protobuf_ShutdownFile_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto();
...
class PB_ComplexNumber : public ::google::protobuf::MessageLite {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_ComplexNumber)
 private:
...
class PB_Phone : public ::google::protobuf::MessageLite {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_Phone)
 private:
...
class PB_Person : public ::google::protobuf::MessageLite {
 public:
  ...
  // optional .Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_Address addres = 1;
  inline bool has_addres() const;
  inline void clear_addres();
  static const int kAddresFieldNumber = 1;
  inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address& addres() const;
  inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address* mutable_addres();
  inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address* release_addres();
  ...
  // optional .Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_Person mother = 4;
  inline bool has_mother() const;
  inline void clear_mother();
  static const int kMotherFieldNumber = 4;
  inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person& mother() const;
  inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person* mutable_mother();
  inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person* release_mother();
  
  // @@protoc_insertion_point(class_scope:Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_Person)
 private:
  ...
  ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address* addres_;
  ::std::string* name_;
  ::std::string* surname_;
  ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person* mother_;
...
class PB_TupleComplexNumber : public ::google::protobuf::MessageLite {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_TupleComplexNumber)
 private:
  inline void set_has_a();
  inline void clear_has_a();
  inline void set_has_b();
...
class PB_ValidationException : public ::google::protobuf::MessageLite {
 public:
  ...
  // @@protoc_insertion_point(class_scope:Trentino.Example.BasicCalculatorRemoteClient.protobuf.PB_ValidationException)
 private:
...
inline void PB_Address::clear_phone() {
  if (phone_ != NULL) phone_->::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone::Clear();
  clear_has_phone();
}
inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone& PB_Address::phone() const {
  return phone_ != NULL ? *phone_ : *default_instance_->phone_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone* PB_Address::mutable_phone() {
  set_has_phone();
  if (phone_ == NULL) phone_ = new ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone;
  return phone_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone* PB_Address::release_phone() {
  clear_has_phone();
  ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Phone* temp = phone_;
  phone_ = NULL;
  return temp;
}
...
inline void PB_Person::clear_addres() {
  if (addres_ != NULL) addres_->::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address::Clear();
  clear_has_addres();
}
inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address& PB_Person::addres() const {
  return addres_ != NULL ? *addres_ : *default_instance_->addres_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address* PB_Person::mutable_addres() {
  set_has_addres();
  if (addres_ == NULL) addres_ = new ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address;
  return addres_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address* PB_Person::release_addres() {
  clear_has_addres();
  ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Address* temp = addres_;
  addres_ = NULL;
  return temp;
}
...
inline void PB_Person::clear_mother() {
  if (mother_ != NULL) mother_->::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person::Clear();
  clear_has_mother();
}
inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person& PB_Person::mother() const {
  return mother_ != NULL ? *mother_ : *default_instance_->mother_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person* PB_Person::mutable_mother() {
  set_has_mother();
  if (mother_ == NULL) mother_ = new ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person;
  return mother_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person* PB_Person::release_mother() {
  clear_has_mother();
  ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_Person* temp = mother_;
  mother_ = NULL;
  return temp;
}
...
inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber& PB_TupleComplexNumber::a() const {
  return a_ != NULL ? *a_ : *default_instance_->a_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber* PB_TupleComplexNumber::mutable_a() {
  set_has_a();
  if (a_ == NULL) a_ = new ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber;
  return a_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber* PB_TupleComplexNumber::release_a() {
  clear_has_a();
...
inline const ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber& PB_TupleComplexNumber::b() const {
  return b_ != NULL ? *b_ : *default_instance_->b_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber* PB_TupleComplexNumber::mutable_b() {
  set_has_b();
  if (b_ == NULL) b_ = new ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber;
  return b_;
}
inline ::Trentino::Example::BasicCalculatorRemoteClient::protobuf::PB_ComplexNumber* PB_TupleComplexNumber::release_b() {
  clear_has_b();
...
#endif  // PROTOBUF_TrentinoExampleBasicCalculatorRemoteClientBasicCalculatorTypes_2eproto__INCLUDED
