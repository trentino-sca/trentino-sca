...
#ifndef TrentinoInvocationBasicCalculatorReturnVoidTestH
#define TrentinoInvocationBasicCalculatorReturnVoidTestH
...
#include "../ProxiesAndWrappers/BasicCalculatorReturnVoidGen__TrentinoGenProxiesWrappers.h"
...
namespace BasicCalculatorReturnVoid
{
   ...
   class BasicCalculatorReturnVoidInvocationTest:  public ::testing::Test
   {
      //service
   protected:
   void SetUp();
...
#endif TrentinoInvocationBasicCalculatorReturnVoidTestH
