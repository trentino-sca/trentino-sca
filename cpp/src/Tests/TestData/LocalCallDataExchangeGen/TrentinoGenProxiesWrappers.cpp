   ...
   //*************************************************************************************************
		...
		,void* targetInstance) const
	{
		      ...
		      if(op =="method_with_one_value_return_a_const_Reference" )
      {
     	 ...
     	 Trentino::LocalCallDataExchange::ClassB& param0 = *static_cast<Trentino::LocalCallDataExchange::ClassB*>(data->parameters()[0]);
      	 
         Trentino::LocalCallDataExchange::ClassC const ** result = new const Trentino::LocalCallDataExchange::ClassC*;
		      ...
		      if(op =="method_has_many_value_or_const_parameters" )
      {
     	 ...
     	 Trentino::LocalCallDataExchange::ClassC& param2 = *static_cast<Trentino::LocalCallDataExchange::ClassC*>(data->parameters()[2]);
        
     	 Trentino::LocalCallDataExchange::ClassA& param3 = *static_cast<Trentino::LocalCallDataExchange::ClassA*>(data->parameters()[3]);
        
     	 Trentino::LocalCallDataExchange::ClassB& param4 = *static_cast<Trentino::LocalCallDataExchange::ClassB*>(data->parameters()[4]);
		      ...
		      if(op =="method_has_a_template_class_as_argument" )
      {
     	 ...
     	 std::vector<Trentino::LocalCallDataExchange::ClassA>& param0 = *static_cast<std::vector<Trentino::LocalCallDataExchange::ClassA>*>(data->parameters()[0]);
