...
#ifdef WIN32
#ifdef TRENTINOLOCALCALLDATAEXCHANGEGEN_EXPORTS
#undef TRENTINOLOCALCALLDATAEXCHANGEGEN_IMPORT_EXPORT
#define TRENTINOLOCALCALLDATAEXCHANGEGEN_IMPORT_EXPORT __declspec(dllexport)
#else
#undef TRENTINOLOCALCALLDATAEXCHANGEGEN_IMPORT_EXPORT
#define TRENTINOLOCALCALLDATAEXCHANGEGEN_IMPORT_EXPORT __declspec(dllimport)       
#endif //TRENTINOLOCALCALLDATAEXCHANGEGEN_EXPORTS
#else
#define TRENTINOLOCALCALLDATAEXCHANGEGEN_IMPORT_EXPORT
#endif //WIN32


// This is an example of an exported function.
extern "C" TRENTINOLOCALCALLDATAEXCHANGEGEN_IMPORT_EXPORT void TRENTINO_CDECL loadModels(Trentino::Core::SCAModelLoader* modelLoader)
{
   ...
   Trentino::Core::SCAModelLoader::SCAModelFactory& factory = modelLoader->scaModelFactory();
						...
						ServiceAImpl_TrentinoLocalCallDataExchangeServiceABImplImplementation->setAllowsPassByReference(false);
								...
								ServiceAImpl_TrentinoLocalCallDataExchangeServiceABImplImplementation->setLibrary("TrentinoLocalCallDataExchange");
					...
					LocalCallDataExchangeCompositeWrapper_LocalCallDataExchangeComposite->addComponentElement(LocalCallDataExchangeComposite_ServiceAImpl);
						...
						ServiceBImpl_TrentinoLocalCallDataExchangeServiceABImplImplementation2->setAllowsPassByReference(false);
								...
								ServiceBImpl_TrentinoLocalCallDataExchangeServiceABImplImplementation2->setLibrary("TrentinoLocalCallDataExchange");
