...
#ifndef TrentinoDiscoveryMethodInterfaceFakeH
#define TrentinoDiscoveryMethodInterfaceFakeH
...
namespace Discovery
{
   ...
   class TrentinoDiscoveryMethodFake : public DiscoveryMethodInterface 
   {
   public:
	   TrentinoDiscoveryMethodFake();
      void start(DiscoveryTask*  taskStart);
      void stop(DiscoveryTask* taskStart);
...
#endif //TrentinoDiscoveryMethodInterfaceFakeH