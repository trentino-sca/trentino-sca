...
namespace Trentino{
 ...
 //! \brief return x="OK" if a.a is 2, b.elems has two elements, b.aObject.b is 1
      ...
      private:
         ...
         ServiceB* mServiceB;
		 		 Trentino::LocalCallDataExchange::ClassC& deneme(  );
		 Trentino::LocalCallDataExchange::ClassC& deneme2(  );
         };
      ...
      private:
         ...
         //oasis::sca::ComponentContext* mComponentContext;
         ServiceA* mServiceA;
		  Trentino::LocalCallDataExchange::ClassC& denemeB(  );
		 Trentino::LocalCallDataExchange::ClassC& denemeB2(  );
