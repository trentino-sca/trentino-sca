...
//specific
#include "I:/Trentino/trentino/DEV/cpp/src/Tests/SystemTestData/BasicCalculator/TrentinoExampleBasicCalculatorCalculatorImpl.h"
#include "I:/Trentino/trentino/DEV/cpp/src/Tests/SystemTestData/BasicCalculator/TrentinoExampleBasicCalculatorDividerImpl.h"
...
namespace Gen
{
   ...
   public:
      InitializerTrentino_Example_BasicCalculator_CalculatorImplRflx()
      {
		 ...
		 //We have to set the parameters for each reference of compType
         	static const Trentino::Reflection::Data::Method::Param setDividerMethodParams[] = {"Divider *" };//content of the reference/interface.cpp/@class
   ...
   public:
      InitializerTrentino_Example_BasicCalculator_DividerImplRflx()
      {
         //delete parameter
         //struct is necessary to find correct parameterlist by runtime
         static const Trentino::Reflection::Data::Method::Param deleteParamMyComponent[] = {"Trentino::Example::BasicCalculator::DividerImpl *"};
   ...
   static InitializerTrentino_Example_BasicCalculator_DividerImplRflx mInitializerTrentino_Example_BasicCalculator_DividerImplRflx2;
