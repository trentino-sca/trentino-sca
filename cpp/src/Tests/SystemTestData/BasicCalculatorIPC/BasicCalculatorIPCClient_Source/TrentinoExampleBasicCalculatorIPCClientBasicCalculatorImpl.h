...
#ifndef TrentinoExampleBasicCalculatorIPCClientBasicCalculatorImplH
#define TrentinoExampleBasicCalculatorIPCClientBasicCalculatorImplH
...
namespace Trentino{
namespace Example{
namespace BasicCalculatorIPCClient
{
   ...
   //**********************************************************************************************
   class BASICCALCULATOR_IMPORT_EXPORT BasicCalculatorIPCClientImpl
   {
   public:
      BasicCalculatorIPCClientImpl();
    virtual ~BasicCalculatorIPCClientImpl();
   ...
   };//class BasicCalculatorIPCClientImpl
