...
//header
#include "LocalCallDataExchangeGen_Trentino_LocalCallDataExchange_TrentinoGenProxiesWrappers.h"
...
namespace LocalCallDataExchangeGen{
		...
		,void* targetInstance) const
	{
		      ...
		      if(op =="method_has_many_value_or_const_parameters" )
      {
			...
			const Trentino::LocalCallDataExchange::ClassB& param4 = *static_cast<const Trentino::LocalCallDataExchange::ClassB*>(data->parameters()[4]);
			 				 Trentino::LocalCallDataExchange::ClassC** result = new  Trentino::LocalCallDataExchange::ClassC*;
					*result =  const_cast< Trentino::LocalCallDataExchange::ClassC*>(&myInstance->method_has_many_value_or_const_parameters(  param0, param1, param2, param3, param4 )); 
				data->setResponse(result);
	...
	class InitializerTrentino_LocalCallDataExchange_ServiceAWrapperRflx
   {
		...
		{
			// METHOD SIGNATURES
			static const Trentino::Reflection::Data::Method::Param deleteParam[] = {"Trentino_LocalCallDataExchange_ServiceAWrapper *"
			};
	...
	static InitializerTrentino_LocalCallDataExchange_ServiceAWrapperRflx mInitializerTrentino_LocalCallDataExchange_ServiceAWrapperRflx2; 
...
//*************************************************************************************************
 ...
 Trentino::LocalCallDataExchange::ClassC* Trentino_LocalCallDataExchange_ServiceBProxy::method_has_a_template_class_as_argument( const std::vector<Trentino::LocalCallDataExchange::ClassA>& valuesOfA)
 {
  ...
  //****************************************************************************************************
   ...
   static InitializerTrentino_LocalCallDataExchange_ServiceBProxyRflx mInitializerTrentino_LocalCallDataExchange_ServiceBProxyRflx3;


//*************************************************************************************************
//Proxy class definition Trentino_LocalCallDataExchange_ServiceAProxy
//*************************************************************************************************
      Trentino_LocalCallDataExchange_ServiceAProxy::Trentino_LocalCallDataExchange_ServiceAProxy(Trentino::RuntimeModel::WireBase* wire):mWire(wire){}  
 Trentino::LocalCallDataExchange::ClassC Trentino_LocalCallDataExchange_ServiceAProxy::method_with_two_parameters_passed_by_value( Trentino::LocalCallDataExchange::ClassA a, Trentino::LocalCallDataExchange::ClassB b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC Trentino_LocalCallDataExchange_ServiceAProxy::method_with_two_parameters_first_by_value_second_by_reference( Trentino::LocalCallDataExchange::ClassA a, Trentino::LocalCallDataExchange::ClassB& b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC Trentino_LocalCallDataExchange_ServiceAProxy::method_with_two_parameters_first_by_const_value_second_by_reference( const Trentino::LocalCallDataExchange::ClassA a, Trentino::LocalCallDataExchange::ClassB& b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC Trentino_LocalCallDataExchange_ServiceAProxy::method_with_two_parameters_first_by_value_second_const_reference( Trentino::LocalCallDataExchange::ClassA a, const Trentino::LocalCallDataExchange::ClassB& b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 const Trentino::LocalCallDataExchange::ClassC Trentino_LocalCallDataExchange_ServiceAProxy::method_with_two_arguments_return_const_value( const Trentino::LocalCallDataExchange::ClassA& a, const Trentino::LocalCallDataExchange::ClassB& b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 const Trentino::LocalCallDataExchange::ClassC& Trentino_LocalCallDataExchange_ServiceAProxy::method_with_one_value_return_a_const_Reference( const Trentino::LocalCallDataExchange::ClassB& b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC* Trentino_LocalCallDataExchange_ServiceAProxy::method_has_a_pointer_and_a_value_return_a_pointer( Trentino::LocalCallDataExchange::ClassA* a, Trentino::LocalCallDataExchange::ClassB b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC* Trentino_LocalCallDataExchange_ServiceAProxy::method_has_two_pointers_return_a_pointer( Trentino::LocalCallDataExchange::ClassA* a, Trentino::LocalCallDataExchange::ClassB* b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC* Trentino_LocalCallDataExchange_ServiceAProxy::method_has_two_const_pointers_return_a_pointer( const Trentino::LocalCallDataExchange::ClassA* a, const Trentino::LocalCallDataExchange::ClassB* b)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC** Trentino_LocalCallDataExchange_ServiceAProxy::method_take_and_return_pointer_of_pointer( const Trentino::LocalCallDataExchange::ClassA** a)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
 ...
 Trentino::LocalCallDataExchange::ClassC* Trentino_LocalCallDataExchange_ServiceAProxy::method_has_a_template_class_as_argument( const std::vector<Trentino::LocalCallDataExchange::ClassA>& valuesOfA)
 {
      assert(mWire);
      const Trentino::RuntimeModel::ServiceBasePtr targetService = mWire->service().lock();
  ...
  //****************************************************************************************************
   ...
   public:
      ...
      {
         // METHOD SIGNATURES
         static const Trentino::Reflection::Data::Method::Param deleteParam[] = {"Trentino_LocalCallDataExchange_ServiceAProxy *"
         };
   ...
   static InitializerTrentino_LocalCallDataExchange_ServiceAProxyRflx mInitializerTrentino_LocalCallDataExchange_ServiceAProxyRflx4;
