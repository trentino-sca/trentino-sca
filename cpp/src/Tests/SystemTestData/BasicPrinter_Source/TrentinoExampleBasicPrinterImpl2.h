...
#ifndef TrentinoExampleBasicPrinterImpl2H
#define TrentinoExampleBasicPrinterImpl2H
...
namespace Example{
   ...
   //**********************************************************************************************
   class BASICPRINTER_IMPORT_EXPORT BasicPrinterImpl2 : public BasicPrinter
   {
   public:
      BasicPrinterImpl2();
      virtual ~BasicPrinterImpl2();
