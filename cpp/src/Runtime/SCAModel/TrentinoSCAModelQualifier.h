...
#ifndef TrentinoSCAModelQualifierH
#define TrentinoSCAModelQualifierH
//standard
#include <vector>
...
namespace Model
{
   ...
   #include "TrentinoSCAModelQualifier.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelQualifierH
