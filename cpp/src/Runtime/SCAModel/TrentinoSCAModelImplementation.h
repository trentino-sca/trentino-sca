...
#ifndef TrentinoSCAModelImplementationH
#define TrentinoSCAModelImplementationH
//baseclass
...
namespace Model
{
   class Implementation : public CommonExtensionBase
   {
      //construction
   public:
      Implementation();
   ...
   #include "TrentinoSCAModelImplementation.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelImplementationH
