...
#ifndef TrentinoSCAModelMetadataTypeH
#define TrentinoSCAModelMetadataTypeH
//standard
#include <vector>
...
namespace Model
{
   ...
   private:
      ...
      void operator=(const MetadataType&);
   ...
   #include "TrentinoSCAModelMetadataType.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelMetadataTypeH
