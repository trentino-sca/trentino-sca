...
#ifndef TrentinoSCAModelRequiresH
#define TrentinoSCAModelRequiresH
//standard
#include <vector>
...
namespace Model
{
   ...
   #include "TrentinoSCAModelRequires.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelRequiresH
