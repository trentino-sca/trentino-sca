...
#ifndef TrentinoSCAModelPolicySetAttachmentH
#define TrentinoSCAModelPolicySetAttachmentH
//standard
#include <vector>
...
namespace Model
{
   ...
   public:
      PolicySetAttachment();
   private:
      PolicySetAttachment(const PolicySetAttachment&);
      void operator=(const PolicySetAttachment&);
   ...
   #include "TrentinoSCAModelPolicySetAttachment.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelPolicySetAttachmentH
