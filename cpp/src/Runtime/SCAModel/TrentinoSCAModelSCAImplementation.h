...
#ifndef TrentinoSCAModelSCAImplementationH
#define TrentinoSCAModelSCAImplementationH
//baseclass
...
namespace Model
{
   class SCAImplementation : public Implementation
   {
      //construction
   public:
      SCAImplementation();
   private:
      SCAImplementation(const SCAImplementation&);
      void operator=(const SCAImplementation&);
   ...
   #include "TrentinoSCAModelSCAImplementation.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelSCAImplementationH
