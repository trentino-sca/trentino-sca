...
#ifndef TrentinoSCAModelExportH
#define TrentinoSCAModelExportH
//baseclass
...
namespace Model
{
   class Export : public CommonExtensionBase
   {
      //construction
   public:
      Export();
   ...
   #include "TrentinoSCAModelExport.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelExportH
