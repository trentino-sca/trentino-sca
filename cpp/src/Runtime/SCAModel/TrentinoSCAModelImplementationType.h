...
#ifndef TrentinoSCAModelImplementationTypeH
#define TrentinoSCAModelImplementationTypeH
//baseclass
...
namespace Model
{
   class ImplementationType : public CommonExtensionBase
   {
      //construction
   public:
      ImplementationType();
   private:
      ImplementationType(const ImplementationType&);
      void operator=(const ImplementationType&);
   ...
   #include "TrentinoSCAModelImplementationType.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelImplementationTypeH
