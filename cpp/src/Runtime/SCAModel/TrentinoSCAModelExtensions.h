...
#ifndef TrentinoSCAModelExtensionsH
#define TrentinoSCAModelExtensionsH
//standard
#include <vector>
...
namespace Model
{
   ...
   private:
      ...
      void operator=(const Extensions&);
   ...
   #include "TrentinoSCAModelExtensions.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelExtensionsH
