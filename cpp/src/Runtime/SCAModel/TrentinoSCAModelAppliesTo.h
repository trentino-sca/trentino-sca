...
#ifndef TrentinoSCAModelAppliesToH
#define TrentinoSCAModelAppliesToH
//standard
#include <vector>
...
namespace Model
{
   ...
   #include "TrentinoSCAModelAppliesTo.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelAppliesToH
