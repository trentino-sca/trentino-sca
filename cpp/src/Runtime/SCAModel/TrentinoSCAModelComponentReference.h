...
#ifndef TrentinoSCAModelComponentReferenceH
#define TrentinoSCAModelComponentReferenceH
//baseclass
...
namespace Model
{
   class ComponentReference : public Contract
   {
      //construction
   public:
      ComponentReference();
   private:
      ...
      void operator=(const ComponentReference&);
   ...
   public:
      ...
      bool isNonOverridable() const;
      SCAMODEL_IMPORT_EXPORT void TRENTINO_STDCALL  setNonOverridable(bool isNonOverridable);
   ...
   protected:
      ...
      bool mIsNonOverridable;
      std::vector<std::string> mTargets;
      bool mIsWiredByImpl;
   }; //class  ComponentReference

   #include "TrentinoSCAModelComponentReference.inl"   

} //namespace Model
} //namespace SCA
} //namespace Trentino

#endif //TrentinoSCAModelComponentReferenceH
