...
//constants
const Trentino::XML::Schema::QName ContributionLoading::XSDTypeImplementationComposite(
   "SCAImplementation", "http://docs.oasis-open.org/ns/opencsa/sca/200912");
const Trentino::XML::Schema::QName ContributionLoading::XSDTypeImplementationCPP(
   "CPPImplementation", "http://docs.oasis-open.org/ns/opencsa/sca/200912");
const Trentino::XML::Schema::QName ContributionLoading::XSDTypeInterfaceCPP(
