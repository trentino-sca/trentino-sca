...
// Exported functions to use LSP initialization functionality directly
OPENSLPDEAMON_IMPORT_EXPORT void SLPDCmdInitializeSlp(int automatic , BOOL* resultCode, char* installServiceResult);
OPENSLPDEAMON_IMPORT_EXPORT void SLPDCmdDeinitializeSlp(void);
