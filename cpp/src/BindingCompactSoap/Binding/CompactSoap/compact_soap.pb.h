...
void BINDINGCOMPACTSOAP_IMPORT_EXPORT protobuf_AddDesc_compact_5fsoap_2eproto();
...
BINDINGCOMPACTSOAP_IMPORT_EXPORT bool Soap_faultcodeEnum_IsValid(int value);
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap_Header : public ::google::protobuf::MessageLite {
 public:
  Soap_Header();
  virtual ~Soap_Header();
  ...
  inline const ::trentino::bindingsca::csoap::Addressing& addressing() const;
  inline ::trentino::bindingsca::csoap::Addressing* mutable_addressing();
  inline ::trentino::bindingsca::csoap::Addressing* release_addressing();
  
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap.Header)
 private:
  inline void set_has_addressing();
  inline void clear_has_addressing();
  
  ::trentino::bindingsca::csoap::Addressing* addressing_;
  
  mutable int _cached_size_;
  ::google::protobuf::uint32 _has_bits_[(1 + 31) / 32];
  
  friend void BINDINGCOMPACTSOAP_IMPORT_EXPORT protobuf_AddDesc_compact_5fsoap_2eproto();
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap_Body : public ::google::protobuf::MessageLite {
 public:
  Soap_Body();
  virtual ~Soap_Body();
  ...
  inline const ::trentino::bindingsca::csoap::Soap_Fault& faultmessage() const;
  inline ::trentino::bindingsca::csoap::Soap_Fault* mutable_faultmessage();
  inline ::trentino::bindingsca::csoap::Soap_Fault* release_faultmessage();
  ...
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap.Body)
 private:
  ...
  ::trentino::bindingsca::csoap::Soap_Fault* faultmessage_;
  ::std::string* content_;
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap_Fault : public ::google::protobuf::MessageLite {
 public:
  Soap_Fault();
  virtual ~Soap_Fault();
  ...
  inline const ::trentino::bindingsca::csoap::Soap_faultcode& code() const;
  inline ::trentino::bindingsca::csoap::Soap_faultcode* mutable_code();
  inline ::trentino::bindingsca::csoap::Soap_faultcode* release_code();
  
  // optional .trentino.bindingsca.csoap.Soap.faultreason Reason = 2;
  inline bool has_reason() const;
  inline void clear_reason();
  static const int kReasonFieldNumber = 2;
  inline const ::trentino::bindingsca::csoap::Soap_faultreason& reason() const;
  inline ::trentino::bindingsca::csoap::Soap_faultreason* mutable_reason();
  inline ::trentino::bindingsca::csoap::Soap_faultreason* release_reason();
  ...
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap.Fault)
 private:
  ...
  ::trentino::bindingsca::csoap::Soap_faultcode* code_;
  ::trentino::bindingsca::csoap::Soap_faultreason* reason_;
  ::std::string* node_;
  ::std::string* role_;
  ::std::string* detail_;
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap_faultreason : public ::google::protobuf::MessageLite {
 public:
  Soap_faultreason();
  ...
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap.faultreason)
 private:
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap_faultcode : public ::google::protobuf::MessageLite {
 public:
  Soap_faultcode();
  ...
  inline ::trentino::bindingsca::csoap::Soap_faultcodeEnum value() const;
  inline void set_value(::trentino::bindingsca::csoap::Soap_faultcodeEnum value);
  ...
  inline const ::trentino::bindingsca::csoap::Soap_subcode& subcode() const;
  inline ::trentino::bindingsca::csoap::Soap_subcode* mutable_subcode();
  inline ::trentino::bindingsca::csoap::Soap_subcode* release_subcode();
  
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap.faultcode)
 private:
  ...
  ::trentino::bindingsca::csoap::Soap_subcode* subcode_;
  int value_;
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap_subcode : public ::google::protobuf::MessageLite {
 public:
  Soap_subcode();
  ...
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap.subcode)
 private:
  inline void set_has_value();
  inline void clear_has_value();
  inline void set_has_subcode();
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap_Envelope : public ::google::protobuf::MessageLite {
 public:
  Soap_Envelope();
  ...
  inline const ::trentino::bindingsca::csoap::Soap_Header& header() const;
  inline ::trentino::bindingsca::csoap::Soap_Header* mutable_header();
  inline ::trentino::bindingsca::csoap::Soap_Header* release_header();
  
  // optional .trentino.bindingsca.csoap.Soap.Body body = 2;
  inline bool has_body() const;
  inline void clear_body();
  static const int kBodyFieldNumber = 2;
  inline const ::trentino::bindingsca::csoap::Soap_Body& body() const;
  inline ::trentino::bindingsca::csoap::Soap_Body* mutable_body();
  inline ::trentino::bindingsca::csoap::Soap_Body* release_body();
  
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap.Envelope)
 private:
  ...
  ::trentino::bindingsca::csoap::Soap_Header* header_;
  ::trentino::bindingsca::csoap::Soap_Body* body_;
...
class BINDINGCOMPACTSOAP_IMPORT_EXPORT Soap : public ::google::protobuf::MessageLite {
 public:
  Soap();
  virtual ~Soap();
  ...
  inline const ::trentino::bindingsca::csoap::Soap_Envelope& envelope() const;
  inline ::trentino::bindingsca::csoap::Soap_Envelope* mutable_envelope();
  inline ::trentino::bindingsca::csoap::Soap_Envelope* release_envelope();
  
  // @@protoc_insertion_point(class_scope:trentino.bindingsca.csoap.Soap)
 private:
  inline void set_has_envelope();
  inline void clear_has_envelope();
  
  ::trentino::bindingsca::csoap::Soap_Envelope* envelope_;
...
inline const ::trentino::bindingsca::csoap::Addressing& Soap_Header::addressing() const {
  return addressing_ != NULL ? *addressing_ : *default_instance_->addressing_;
}
inline ::trentino::bindingsca::csoap::Addressing* Soap_Header::mutable_addressing() {
  set_has_addressing();
  if (addressing_ == NULL) addressing_ = new ::trentino::bindingsca::csoap::Addressing;
  return addressing_;
}
inline ::trentino::bindingsca::csoap::Addressing* Soap_Header::release_addressing() {
  clear_has_addressing();
  ::trentino::bindingsca::csoap::Addressing* temp = addressing_;
  addressing_ = NULL;
  return temp;
}
...
inline const ::trentino::bindingsca::csoap::Soap_Fault& Soap_Body::faultmessage() const {
  return faultmessage_ != NULL ? *faultmessage_ : *default_instance_->faultmessage_;
}
inline ::trentino::bindingsca::csoap::Soap_Fault* Soap_Body::mutable_faultmessage() {
  set_has_faultmessage();
  if (faultmessage_ == NULL) faultmessage_ = new ::trentino::bindingsca::csoap::Soap_Fault;
  return faultmessage_;
}
inline ::trentino::bindingsca::csoap::Soap_Fault* Soap_Body::release_faultmessage() {
  clear_has_faultmessage();
  ::trentino::bindingsca::csoap::Soap_Fault* temp = faultmessage_;
  faultmessage_ = NULL;
  return temp;
}
...
inline const ::trentino::bindingsca::csoap::Soap_faultcode& Soap_Fault::code() const {
  return code_ != NULL ? *code_ : *default_instance_->code_;
}
inline ::trentino::bindingsca::csoap::Soap_faultcode* Soap_Fault::mutable_code() {
  set_has_code();
  if (code_ == NULL) code_ = new ::trentino::bindingsca::csoap::Soap_faultcode;
  return code_;
}
inline ::trentino::bindingsca::csoap::Soap_faultcode* Soap_Fault::release_code() {
  clear_has_code();
  ::trentino::bindingsca::csoap::Soap_faultcode* temp = code_;
  code_ = NULL;
  return temp;
}
...
inline const ::trentino::bindingsca::csoap::Soap_faultreason& Soap_Fault::reason() const {
  return reason_ != NULL ? *reason_ : *default_instance_->reason_;
}
inline ::trentino::bindingsca::csoap::Soap_faultreason* Soap_Fault::mutable_reason() {
  set_has_reason();
  if (reason_ == NULL) reason_ = new ::trentino::bindingsca::csoap::Soap_faultreason;
  return reason_;
}
inline ::trentino::bindingsca::csoap::Soap_faultreason* Soap_Fault::release_reason() {
  clear_has_reason();
  ::trentino::bindingsca::csoap::Soap_faultreason* temp = reason_;
  reason_ = NULL;
  return temp;
}
...
inline ::trentino::bindingsca::csoap::Soap_faultcodeEnum Soap_faultcode::value() const {
  return static_cast< ::trentino::bindingsca::csoap::Soap_faultcodeEnum >(value_);
}
inline void Soap_faultcode::set_value(::trentino::bindingsca::csoap::Soap_faultcodeEnum value) {
  GOOGLE_DCHECK(::trentino::bindingsca::csoap::Soap_faultcodeEnum_IsValid(value));
  set_has_value();
  value_ = value;
}
...
inline const ::trentino::bindingsca::csoap::Soap_subcode& Soap_faultcode::subcode() const {
  return subcode_ != NULL ? *subcode_ : *default_instance_->subcode_;
}
inline ::trentino::bindingsca::csoap::Soap_subcode* Soap_faultcode::mutable_subcode() {
  set_has_subcode();
  if (subcode_ == NULL) subcode_ = new ::trentino::bindingsca::csoap::Soap_subcode;
  return subcode_;
}
inline ::trentino::bindingsca::csoap::Soap_subcode* Soap_faultcode::release_subcode() {
  clear_has_subcode();
  ::trentino::bindingsca::csoap::Soap_subcode* temp = subcode_;
  subcode_ = NULL;
  return temp;
}
...
inline const ::trentino::bindingsca::csoap::Soap_subcode& Soap_subcode::subcode() const {
  return subcode_ != NULL ? *subcode_ : *default_instance_->subcode_;
}
inline ::trentino::bindingsca::csoap::Soap_subcode* Soap_subcode::mutable_subcode() {
  set_has_subcode();
  if (subcode_ == NULL) subcode_ = new ::trentino::bindingsca::csoap::Soap_subcode;
  return subcode_;
}
inline ::trentino::bindingsca::csoap::Soap_subcode* Soap_subcode::release_subcode() {
  clear_has_subcode();
  ::trentino::bindingsca::csoap::Soap_subcode* temp = subcode_;
  subcode_ = NULL;
  return temp;
...
inline const ::trentino::bindingsca::csoap::Soap_Header& Soap_Envelope::header() const {
  return header_ != NULL ? *header_ : *default_instance_->header_;
}
inline ::trentino::bindingsca::csoap::Soap_Header* Soap_Envelope::mutable_header() {
  set_has_header();
  if (header_ == NULL) header_ = new ::trentino::bindingsca::csoap::Soap_Header;
  return header_;
}
inline ::trentino::bindingsca::csoap::Soap_Header* Soap_Envelope::release_header() {
  clear_has_header();
  ::trentino::bindingsca::csoap::Soap_Header* temp = header_;
  header_ = NULL;
  return temp;
}
...
inline const ::trentino::bindingsca::csoap::Soap_Body& Soap_Envelope::body() const {
  return body_ != NULL ? *body_ : *default_instance_->body_;
}
inline ::trentino::bindingsca::csoap::Soap_Body* Soap_Envelope::mutable_body() {
  set_has_body();
  if (body_ == NULL) body_ = new ::trentino::bindingsca::csoap::Soap_Body;
  return body_;
}
inline ::trentino::bindingsca::csoap::Soap_Body* Soap_Envelope::release_body() {
  clear_has_body();
  ::trentino::bindingsca::csoap::Soap_Body* temp = body_;
  body_ = NULL;
  return temp;
}
...
inline const ::trentino::bindingsca::csoap::Soap_Envelope& Soap::envelope() const {
  return envelope_ != NULL ? *envelope_ : *default_instance_->envelope_;
}
inline ::trentino::bindingsca::csoap::Soap_Envelope* Soap::mutable_envelope() {
  set_has_envelope();
  if (envelope_ == NULL) envelope_ = new ::trentino::bindingsca::csoap::Soap_Envelope;
  return envelope_;
}
inline ::trentino::bindingsca::csoap::Soap_Envelope* Soap::release_envelope() {
  clear_has_envelope();
  ::trentino::bindingsca::csoap::Soap_Envelope* temp = envelope_;
  envelope_ = NULL;
  return temp;
}
