...
@XmlType(name = "OperatorContentType", namespace = "http://www.w3.org/ns/ws-policy", propOrder = {
...
public class OperatorContentType {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "Policy", namespace = "http://www.w3.org/ns/ws-policy", type = Policy.class),
        @XmlElementRef(name = "All", namespace = "http://www.w3.org/ns/ws-policy", type = JAXBElement.class),
        @XmlElementRef(name = "PolicyReference", namespace = "http://www.w3.org/ns/ws-policy", type = PolicyReference.class),
        @XmlElementRef(name = "ExactlyOne", namespace = "http://www.w3.org/ns/ws-policy", type = JAXBElement.class)
    })
