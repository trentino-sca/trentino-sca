...
namespace BasicCalculator
{
   ...
   //**********************************************************************************************
   class BASICCALCULATOR_IMPORT_EXPORT CalculatorImpl : public TrentinoExampleBasicCalculatorCalculator
   {
   public:
      CalculatorImpl();
      ...
      void setDivider(TrentinoExampleBasicCalculatorDivider* divider);
