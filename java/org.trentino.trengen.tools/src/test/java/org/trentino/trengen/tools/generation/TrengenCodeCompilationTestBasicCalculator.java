 ...
 * @author z002ttbb
 */
public class TrengenCodeCompilationTestBasicCalculator extends TrentinoTest {

    private static TrengenCodeCompilationTestUtil util;


	static String contributionName = "BasicCalculator_Source";
	static String contributionPath = "BasicCalculator_Source";
	
	@BeforeClass
	public static void init() throws TrengenException, Exception {
		util = new TrengenCodeCompilationTestUtil(contributionName, contributionPath,null,null);
	}
