 ...
 * @author z002ttbb
 */
public class TrengenCodeCompilationTestBasicCalculatorRemoteNotEnclosedTypes extends TrentinoTest {

	private static TrengenCodeCompilationTestUtil	util;

	static String	                              contributionName	= "BasicCalculatorRemoteNotEnclosedTypes_Source";
	static String	                              contributionPath	= "BasicCalculatorRemoteNotEnclosedTypes_Source";

	@BeforeClass
	public static void init() throws TrengenException, Exception {
		List<String> paths = new ArrayList<String>();
		paths.add("services/TrentinoExampleBasicCalculatorRemoteBasicCalculator.tidl.properties");
