 ...
 * @author z002ttbb
 */
public class TrengenCodeCompilationTestBasicCalculatorRemote extends TrentinoTest {

	private static TrengenCodeCompilationTestUtil	util;

	static String	                              contributionName	= "BasicCalculatorRemote_Source";
	static String	                              contributionPath	= "BasicCalculatorRemote_Source";
