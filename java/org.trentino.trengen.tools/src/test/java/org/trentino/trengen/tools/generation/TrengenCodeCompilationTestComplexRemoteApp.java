 ...
 * @author z002ttbb
 */
public class TrengenCodeCompilationTestComplexRemoteApp extends TrentinoTest {

	private static TrengenCodeCompilationTestUtil	util;

	static String	                              contributionName	= "App_Source";
	static String	                              contributionPath	= "ComplexRemotApp/App_Source";

	@BeforeClass
	public static void init() throws TrengenException, Exception {
		List<String> paths = new ArrayList<String>();
		paths.add("AppService1.java");
		paths.add("AppService2.java");
