 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.w3.org/ns/ws-policy}AppliesTo"/>
...
@XmlRootElement(name = "PolicyAttachment", namespace = "http://www.w3.org/ns/ws-policy")
public class PolicyAttachment {

    @XmlElement(name = "AppliesTo", namespace = "http://www.w3.org/ns/ws-policy", required = true)
    protected AppliesTo appliesTo;
    @XmlElements({
        @XmlElement(name = "PolicyReference", namespace = "http://www.w3.org/ns/ws-policy", type = PolicyReference.class),
        @XmlElement(name = "Policy", namespace = "http://www.w3.org/ns/ws-policy", type = Policy.class)
    })
