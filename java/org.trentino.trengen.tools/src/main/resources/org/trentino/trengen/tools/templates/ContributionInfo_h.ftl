...
#ifndef ${contributionName}_ContributionInfoH
#define ${contributionName}_ContributionInfoH
...
namespace Gen{
  ...
  class ${contributionName}ContributionInfo: public Trentino::Core::TrentinoContributionInfo {
CONTRIBUTION_HEADER_BODY(${contributionName})
  public:
  ...
  static Trentino::Reflection::DataRegistry& TRENTINO_CDECL getDataRegistry();
     }; //class ${contributionName}ContributionInfo
     
   typedef std::vector<BindingHelperFactory> BindingHelperFactoryList;
}//namespace Gen
}//namespace Trentino

#endif //${contributionName}_ContributionInfoH